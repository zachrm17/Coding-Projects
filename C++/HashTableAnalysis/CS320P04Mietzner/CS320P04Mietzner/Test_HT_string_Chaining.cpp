...
{
	{
		...
		cout << "****Starting analysis of HashTable<string> using Seperate Chaining****" << endl;
		htAnalysisFile << "****Starting analysis of HashTable<string> using Seperate Chainig***" << endl;
		...
		htAnalysisFile << "HT<string> Seperate Chaining Initial Insertion of strings:\n";
		...
		htAnalysisFile << "HT<string> seperate chaining Successful 'Contains' Probes Totals:\n";
		for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
			htAnalysisFile << i << "\t\t";
		}
		htAnalysisFile << endl;
		...
		htAnalysisFile << endl;
		htAnalysisFile << "HT<string> seperate chaining Average Successful 'Contains': \n";
		for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
			htAnalysisFile << resultSuccessContainsTotalProbes[i] / static_cast<double>(successfulTotal[i]) << "\t";
		}
		htAnalysisFile << endl;
		htAnalysisFile << "HT<string> seperate chaining Unsuccessful 'Contains' Probe Totals: \n";
		for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
			htAnalysisFile << i << "\t\t";
		}
		htAnalysisFile << endl;
		...
		htAnalysisFile << endl;
		htAnalysisFile << "HT<string> seperate chaining probing Average Unsuccessful Contains: \n";
		for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
			htAnalysisFile << resultUnSuccessContainsTotalProbes[i] / static_cast<double>(unsuccessfulTotal[i]) << "\t";
		}
		htAnalysisFile << endl;
		htAnalysisFile << "****Finished analysis of HashTable<string> using seperate chaining****" << endl;
		cout << "****Finished analysis of HashTable<string> using seperate chaining****" << endl;
		htAnalysisFile << endl;
	}
}

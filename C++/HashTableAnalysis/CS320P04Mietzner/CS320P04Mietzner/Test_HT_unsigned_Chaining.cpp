...
//****************Testing HashTable with Chaining  using unsigned keys*****************
{
	...
	////Test Seperate Chaining with vector of HashTableChaining<unsigned>
	cout << "****Starting analysis of HashTable<unsigned> using Seperate Chaining ****" << endl;
	htAnalysisFile << "****Starting analysis of HashTable<unsigned> using Seperate Chaining ****" << endl;
	...
	htAnalysisFile << "Seperate Chaining Successful Contains Results:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << "Seperate Chaning Unsuccessful Contains Results:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << endl;
	cout << "****Finished analysis of HashTableChaining<unsigned> using Seperate Chaining ****" << endl;
	htAnalysisFile << "****Finished analysis of HashTableChaining<unsigned> using Sepereate Chaining ****" << endl;
	htAnalysisFile << endl;
}
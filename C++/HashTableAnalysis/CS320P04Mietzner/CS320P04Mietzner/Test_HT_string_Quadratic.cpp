...
//****************Testing HashTable with Chaining using string keys*****************
{
	...
	htAnalysisFile << "HT<string> Quadtratic Probing Initial Insertion of strings:\n";
	...
	htAnalysisFile << endl;
	htAnalysisFile << "HT<string> quadtratic probing Average Unsuccessful Contains: \n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << resultUnSuccessContainsTotalProbes[i] / static_cast<double>(unsuccessfulTotal[i]) << "\t";
	}
	htAnalysisFile << endl;
	htAnalysisFile << "****Finished analysis of HashTable<string> using quadtratic probing****" << endl;
	cout << "****Finished analysis of HashTable<string> using quadtratic probing****" << endl;
	htAnalysisFile << endl;
}
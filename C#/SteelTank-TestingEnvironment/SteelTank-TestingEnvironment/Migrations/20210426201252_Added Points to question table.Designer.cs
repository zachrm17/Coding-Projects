...
namespace SteelTank_TestingEnvironment.Migrations
{
    ...
    [Migration("20210426201252_Added Points to question table")]
    partial class AddedPointstoquestiontable
    {
            ...
            modelBuilder.Entity("SteelTank_TestingEnvironment.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("AccountAddress2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AccountCompany")
                        .HasColumnType("nvarchar(max)");

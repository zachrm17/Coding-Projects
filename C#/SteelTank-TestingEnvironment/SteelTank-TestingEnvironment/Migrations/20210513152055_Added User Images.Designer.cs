...
namespace SteelTank_TestingEnvironment.Migrations
{
    ...
    [Migration("20210513152055_Added User Images")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SteelTank_TestingEnvironment.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("SiteInformationApproved")
                        .HasColumnType("bit");

                    b.Property<bool>("SiteInformationReceived")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("UserFile1Id")
                        .HasColumnType("int");

                    b.Property<int?>("UserFile2Id")
                        .HasColumnType("int");

                    b.Property<int?>("UserFile3Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserFile1Id");

                    b.HasIndex("UserFile2Id");

                    b.HasIndex("UserFile3Id");
            ...
            modelBuilder.Entity("SteelTank_TestingEnvironment.Data.Models.ImageFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SteelTank_TestingEnvironment.Data.Models.UserFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SteelTank_TestingEnvironment.Data.Models.ApplicationUser", b =>
                {
                    b.HasOne("SteelTank_TestingEnvironment.Data.Models.UserFile", "UserFile1")
                        .WithMany()
                        .HasForeignKey("UserFile1Id");

                    b.HasOne("SteelTank_TestingEnvironment.Data.Models.UserFile", "UserFile2")
                        .WithMany()
                        .HasForeignKey("UserFile2Id");

                    b.HasOne("SteelTank_TestingEnvironment.Data.Models.UserFile", "UserFile3")
                        .WithMany()
                        .HasForeignKey("UserFile3Id");

                    b.Navigation("UserFile1");

                    b.Navigation("UserFile2");

                    b.Navigation("UserFile3");
                });
